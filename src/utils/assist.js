...
export function warnProp(component, prop, correctType, wrongType) {
    ...
    console.error(`[Vued warn]: Invalid prop: type check failed for prop ${prop}. Expected ${correctType}, got ${wrongType}. (found in component: ${component})`); // eslint-disable-line
}
