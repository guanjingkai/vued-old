                    ...
                    <div :class="cellClasses(column)">
                        ...
                        <template v-else>
                            ...
                            <span :class="[prefixCls + '-sort']" v-if="column.sortable">
                                <i class="ued-icon ued-icon-arrow-up-b" :class="{on: column._sortType === 'asc'}" @click="handleSort(index, 'asc')"></i>
                                <i class="ued-icon ued-icon-arrow-down-b" :class="{on: column._sortType === 'desc'}" @click="handleSort(index, 'desc')"></i>
                            </span>
                            <Poptip
                                ...
                                <span :class="[prefixCls + '-filter']">
                                    <i class="ued-icon ued-icon-funnel" :class="{on: column._isFiltered}"></i>
                                </span>
