<template>
    <ul :class="simpleWrapClasses" :style="styles" v-if="simple">
        <li
            ...
            :class="prevClasses"
            @click="prev">
            <a><i class="ued-icon ued-icon-ios-arrow-left"></i></a>
        </li>
        ...
        <li
            ...
            :class="nextClasses"
            @click="next">
            <a><i class="ued-icon ued-icon-ios-arrow-right"></i></a>
        </li>
    </ul>
    <ul :class="wrapClasses" :style="styles" v-else>
        ...
        <li :title="t('i.page.prev5')" v-if="currentPage - 3 > 1" :class="[prefixCls + '-item-jump-prev']" @click="fastPrev"><a><i class="ued-icon ued-icon-ios-arrow-left"></i></a></li>
        ...
        <li :title="t('i.page.next5')" v-if="currentPage + 3 < allPages" :class="[prefixCls + '-item-jump-next']" @click="fastNext"><a><i class="ued-icon ued-icon-ios-arrow-right"></i></a></li>
